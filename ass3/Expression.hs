...
intShow :: Expr -> String -> Expr -> String
intShow (Val l) op e2 = show l               ++ op ++ intShow2 e2
intShow (Var l) op e2 =      l               ++ op ++ intShow2 e2
intShow (    l) op e2 = "(" ++ show l ++ ")" ++ op ++ intShow2 e2
intShow2 :: Expr -> String
intShow2 (Val r) = show r
intShow2 (Var r) = r
intShow2      r  = "(" ++ show r ++ ")"
